...
public class ProductSpecificationListAdapter extends RecyclerView.Adapter<ProductSpecificationListAdapter.ViewHolder> {
    ...
    public ProductSpecificationListAdapter(Context context, List<ProductSpecificationModel> specificationModelList, int viewType) {
        this.ctx = context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)  {
        ...
        View view = layoutInflater.from(parent.getContext()).inflate(R.layout.eachitem_product_detail_specification,parent,false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            key = itemView.findViewById(R.id.eachItem_specification_key);
            value = itemView.findViewById(R.id.eachItem_specification_value);
            line = itemView.findViewById(R.id.eachItem_specification_line);
        }
